...
- Add basic sphinx configuration by @johnchildren in [#123](https://github.com/Quantinuum/tierkreis/pull/123)
...
[2.1.0]: https://github.com/Quantinuum/tierkreis/compare/v2.0.4...v2.1.0
